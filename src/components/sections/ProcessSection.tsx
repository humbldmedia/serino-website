              ...
              <div style={{
                ...
                <div style={{ width: '50%', flexShrink: 0, paddingLeft: '2.5rem' }}>
                  ...
                  <div className="space-y-4 leading-relaxed mb-10">
                    ...
                    <p className="font-body text-roma-cream/70" style={{ fontSize: '0.875rem' }}>No, a brand logo is not all you need. Without a clear identity, voice, and plan established from the start, teams pull in different directions, messaging becomes inconsistent, and the energy that launched the idea slowly turns into burnout and dysfunction.</p>
