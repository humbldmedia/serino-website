...
export const proofVideos = {
  directStay: {
    ...
    // poster left blank → auto-uses Stream's generated thumbnail
...
export const verticalClips: VideoSource[] = [
  { streamUid: '6efe5fe37e0e3984fb5ddf8d7ca5bb31', title: 'The Haunted Listing' }, // Skit
  { streamUid: '12045e484429034ef40822868dcf6f7e', title: 'Rooted in the Community', thumbTime: '6s' }, // Interview
  { streamUid: '1f320c64d4a17f74a90f1893c919adbc', title: 'This Just In' }, // Remix / pattern interrupt
]
